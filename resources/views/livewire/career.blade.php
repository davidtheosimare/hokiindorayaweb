<div>
    <section class="pb-0 overflow-hidden top-space-padding bg-gradient-very-light-gray position-relative lg-pb-30px">
        <div class="container h-100">
            ...
            <div class="position-absolute top-20 right-10 animation-rotation d-none d-sm-block">
                <img src="https://placehold.co/90x80" data-bottom-top="transform: rotate(-50deg) translateY(-50px)" data-top-bottom="transform:rotate(10deg) translateY(50px)" alt="">
            </div>
            <div class="position-absolute bottom-50px left-0px animation-float d-none d-xl-block">
                <img src="https://placehold.co/220x350" data-bottom-top="transform: translateY(150px)" data-top-bottom="transform: translateY(-150px)" alt="">
            </div>
            <div class="row align-items-center h-100 md-mt-50px">
                <div class="col-xl-6 col-lg-6 mb-9 position-relative z-index-1" data-anime='{ "el": "childs", "translateY": [30, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 300, "easing": "easeOutQuad" }'>
                    <div class="d-flex align-items-start align-items-sm-center alt-font mb-30px">
                        <div class="flex-shrink-0 text-white bg-cabaret-red fw-600 text-uppercase ps-20px pe-20px fs-12 me-15px border-radius-100px">Get started</div>
                    ...
                    <a href="mailto:start@domain.com" class="p-0 align-middle btn btn-link btn-hover-animation-switch btn-extra-large text-dark-gray btn-icon-left xs-mt-20px xs-mb-20px">
                        <span>
    ...
    <section class="p-0 position-relative">
        ...
        <div class="container">
            <div class="mb-2 row justify-content-center" data-anime='{ "el": "childs", "translateY": [30, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 300, "easing": "easeOutQuad" }'>
                <div class="text-center col-xxl-6 col-xl-7 col-lg-8 col-md-9">
                    <div class="text-white bg-base-color fw-600 text-uppercase ps-20px pe-20px fs-12 border-radius-100px d-inline-block mb-15px">About company</div>
            ...
            <div class="mb-2 row row-cols-1 row-cols-lg-2 justify-content-center" data-anime='{ "el": "childs", "perspective": [1200,1200], "translateY": [30, 0], "scale": [1.05, 1], "rotateX": [30, 0], "opacity": [0,1], "duration": 800, "delay": 0, "staggervalue": 300, "easing": "easeOutQuad" }'>
                <!-- start features box item -->
                <div class="col icon-with-text-style-02 transition-inner-all mb-30px">
                    <div class="pt-8 pb-8 overflow-hidden feature-box feature-box-left-icon text-start bg-ghost-white border-radius-4px ps-10 pe-10 last-paragraph-no-margin xs-pe-5 xs-ps-5">
                ...
                <!-- start features box item -->
                <div class="col icon-with-text-style-02 transition-inner-all mb-30px">
                    <div class="pt-8 pb-8 overflow-hidden feature-box feature-box-left-icon text-start bg-cosmic-latte-white border-radius-4px ps-10 pe-10 last-paragraph-no-margin xs-pe-5 xs-ps-5">
                        <div class="feature-box-icon">
                            <img src="https://placehold.co/60x60" alt=""/>
                        </div>
                        <div class="feature-box-content">
                ...
                <!-- start features box item -->
                <div class="col icon-with-text-style-02 transition-inner-all mb-30px">
                    <div class="pt-8 pb-8 overflow-hidden feature-box feature-box-left-icon text-start bg-chablis-red border-radius-4px ps-10 pe-10 last-paragraph-no-margin position-relative xs-pe-5 xs-ps-5">
                        <div class="feature-box-icon">
                            <img src="https://placehold.co/60x60" alt=""/>
                        </div>
                        <div class="feature-box-content">
                ...
                <!-- start features box item -->
                <div class="col icon-with-text-style-02 transition-inner-all mb-30px">
                    <div class="pt-8 pb-8 overflow-hidden feature-box feature-box-left-icon text-start bg-lavender-violet border-radius-4px ps-10 pe-10 last-paragraph-no-margin xs-pe-5 xs-ps-5">
                        <div class="feature-box-icon">
                            <img src="https://placehold.co/60x60" alt=""/>
                        </div>
                        <div class="feature-box-content">
    ...
    <section class="pb-0 position-relative">
        ...
        <div class="container position-relative">
            <div class="mb-4 row align-items-center sm-mb-25px">
                <div class="text-center col-xl-6 col-lg-6 text-lg-start md-mb-30px" data-anime='{ "translate": [0, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 300, "easing": "easeOutQuad" }'>
                    <img src="https://placehold.co/580x740" class="md-w-70 sm-w-100" data-bottom-top="transform: translateY(-50px)" data-top-bottom="transform: translateY(50px)" alt="">
                </div>
                <div class="col-xl-5 col-lg-6 offset-xl-1" data-anime='{ "el": "childs", "translateY": [30, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 300, "easing": "easeOutQuad" }'>
                    <div class="text-white bg-base-color fw-600 text-uppercase ps-20px pe-20px fs-12 border-radius-100px d-inline-block mb-25px">Effective benefits</div>
                    ...
                    <div class="mt-35px">
                        ...
                        <a href="#" class="p-0 align-middle btn btn-link btn-hover-animation-switch btn-extra-large text-dark-gray btn-icon-left xs-mt-20px xs-mb-20px">
                            <span>
                ...
                <div class="col swiper text-cente" data-slider-options='{ "slidesPerView": "auto", "spaceBetween":0, "centeredSlides": true, "speed": 10000, "loop": true, "pagination": { "el": ".slider-four-slide-pagination-2", "clickable": false }, "allowTouchMove": false, "autoplay": { "delay":1, "disableOnInteraction": false }, "navigation": { "nextEl": ".slider-four-slide-next-2", "prevEl": ".slider-four-slide-prev-2" }, "keyboard": { "enabled": true, "onlyInViewport": true }, "effect": "slide" }'>
                    <div class="swiper-wrapper swiper-width-auto pb-60px sm-pb-30px marquee-slide">
                        ...
                        <div class="swiper-slide">
                            <div class="fs-120 lh-120 alt-font text-outline text-outline-color-extra-medium-gray fw-700"><span class="align-middle w-20px h-20px border-radius-100 border-color-extra-medium-gray d-inline-block ms-50px me-50px sm-ms-30px sm-me-30px"></span>predictive analytics</div>
                        </div>
                        <!-- end client item -->
                        <!-- start client item -->
                        <div class="swiper-slide">
                            <div class="fs-120 lh-120 alt-font text-outline text-outline-color-extra-medium-gray fw-700"><span class="align-middle w-20px h-20px border-radius-100 border-color-extra-medium-gray d-inline-block ms-50px me-50px sm-ms-30px sm-me-30px"></span>data engineers</div>
                        </div>
                        <!-- end client item -->
                        <!-- start client item -->
                        <div class="swiper-slide">
                            <div class="fs-120 lh-120 alt-font text-outline text-outline-color-extra-medium-gray fw-700"><span class="align-middle w-20px h-20px border-radius-100 border-color-extra-medium-gray d-inline-block ms-50px me-50px sm-ms-30px sm-me-30px"></span>statistical modeling</div>
                        </div>
                        <!-- end client item -->
                        <!-- start client item -->
                        <div class="swiper-slide">
                    ...
                    <div class="outside-box-right-40 sm-outside-box-right-0">
                        <div class="swiper magic-cursor" data-slider-options='{ "slidesPerView": 1, "spaceBetween": 30, "loop": true, "autoplay": { "delay": 4000, "disableOnInteraction": false },  "pagination": { "el": ".slider-three-slide-pagination", "clickable": true, "dynamicBullets": false }, "keyboard": { "enabled": true, "onlyInViewport": true }, "breakpoints": { "992": { "slidesPerView": 2 }, "768": { "slidesPerView": 2 }, "320": { "slidesPerView": 1 } }, "effect": "slide" }'>
                            <div class="swiper-wrapper pt-20px">
                                <!-- start slider item -->
                                <div class="swiper-slide">
                                    <div class="overflow-hidden p-11 bg-gradient-very-ghost-white position-relative border-radius-6px xl-p-8">
    ...
    <!-- end section -->
    <!-- start section -->
    <section class="pb-4 overflow-hidden position-relative">
        ...
        <div class="position-absolute top-20 right-minus-50px sm-right-15px animation-rotation d-none d-sm-block">
            <img class="lg-w-120px" src="https://placehold.co/150x129"  data-bottom-top="transform: rotate(-10deg) translateX(-80px)" data-top-bottom="transform:rotate(10deg) translateX(80px)" alt="">
        </div>
        <div class="container position-relative">
            ...
            <div class="mb-1 row justify-content-center" data-anime='{ "el": "childs", "translateY": [30, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 300, "easing": "easeOutQuad" }'>
                <div class="text-center col-lg-6 position-relative">
                    <div class="text-white bg-base-color fw-600 text-uppercase ps-20px pe-20px fs-12 border-radius-100px d-inline-block mb-15px">How it works</div>
            ...
            <div class="row row-cols-1 row-cols-lg-3 row-cols-md-2 justify-content-center position-relative" data-anime='{ "el": "childs", "translateY": [30, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 300, "easing": "easeOutQuad" }'>
                ...
                <div class="pt-6 pb-6 col process-step-style-10 last-paragraph-no-margin ps-5 pe-5 position-relative lg-ps-4 lg-pe-4 lg-pt-8 sm-pt-60px">
