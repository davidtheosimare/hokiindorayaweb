...
{{-- <div>
    ...
    <section class="pt-0 overflow-hidden position-relative">
        <div class=" position-relative z-index-9">
            <div class="align-items-center mt-7 xs-mb-30px xs-mt-35px">


            </div>
            <div class="row">
                <div class="col-12 filter-content">
                    <ul class="grid text-center shop-wrapper shop-grid grid-loading grid-2col xxl-grid-2col xl-grid-2col lg-grid-2col md-grid-1col sm-grid-1col xs-grid-1col gutter-large" data-anime='{ "el": "childs", "translate": [50, 0], "opacity": [0,1], "duration": 600, "delay":150, "staggervalue": 150, "easing": "easeOutQuad" }'>
                        <li class="grid-sizer"></li>
                        <!-- start shop item -->
                        <li class="grid-item">
                            <div class="overflow-hidden shop-box position-relative">
                                <div class="shop-image">
                                    <img src="https://placehold.co/580x540" alt="" />
                                </div>
                                <div class="top-0 left-0 position-absolute w-100 h-100 d-flex align-items-end justify-content-start text-start">
                        ...
                        <li class="grid-item">
                            <div class="overflow-hidden shop-box position-relative">
                                ...
                                <div class="top-0 left-0 position-absolute w-100 h-100 d-flex align-items-center justify-content-start text-start">
                        ...
                        <li class="grid-item">
                            <div class="overflow-hidden shop-box position-relative">
                                ...
                                <div class="top-0 left-0 position-absolute w-100 h-100 d-flex align-items-center justify-content-end text-start">
        ...
        <div class="container">
            <div class="mb-4 row">
                <div class="col-12 tab-style-04">
                    <ul class="border-0 nav nav-tabs justify-content-center text-uppercase fw-600 mb-50px sm-mb-20px alt-font fs-32 ls-minus-05px text-transform-none" data-anime='{ "el": "childs", "translateY": [50, 0], "opacity": [0,1], "duration": 600, "delay":100, "staggervalue": 150, "easing": "easeOutQuad" }'>
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade in active show" id="tab_five1">
                            <div class="row">
                                <div class="col-12 filter-content">
                                    <ul class="grid text-center shop-boxed shop-wrapper grid-4col xxl-grid-5col xl-grid-4col lg-grid-3col md-grid-2col sm-grid-2col xs-grid-1col gutter-large" data-anime='{ "el": "childs", "translateY": [50, 0], "opacity": [0,1], "duration": 600, "delay":150, "staggervalue": 150, "easing": "easeOutQuad" }'>
                                        <li class="grid-sizer"></li>
                                        <!-- start shop item -->
                                        <li class="grid-item">
                                            <div class="shop-box pb-25px">
                                                ...
                                                <div class="text-center shop-footer pt-20px">
                        ...
                        <div class="tab-pane fade in" id="tab_five2">
                            <div class="row">
                                <div class="col-12 filter-content">
                                    <ul class="grid text-center shop-boxed shop-wrapper grid-4col xxl-grid-5col xl-grid-4col lg-grid-3col md-grid-2col sm-grid-2col xs-grid-1col gutter-large">
                                        <li class="grid-sizer"></li>
                                        <!-- start shop item -->
                                        <li class="grid-item">
                                            <div class="shop-box pb-25px">
                ...
                <div class="col swiper text-cente feather-shadow" data-slider-options='{ "slidesPerView": "auto", "spaceBetween":0, "centeredSlides": true, "speed": 8000, "loop": true, "pagination": { "el": ".slider-four-slide-pagination-2", "clickable": false }, "allowTouchMove": false, "autoplay": { "delay":1, "disableOnInteraction": false }, "navigation": { "nextEl": ".slider-four-slide-next-2", "prevEl": ".slider-four-slide-prev-2" }, "keyboard": { "enabled": true, "onlyInViewport": true }, "effect": "slide" }'>
                    <div class="swiper-wrapper pb-20px swiper-width-auto marquee-slide">
                        ...
                        <div class="swiper-slide">
                            <div class="fs-50 text-dark-gray alt-font fw-700 ls-minus-1px"><span class="align-middle border border-2 w-15px h-15px border-radius-100 border-color-medium-gray d-inline-block ms-50px me-50px"></span> Pay with multiple credit cards</div>
                        </div>
                        <!-- end client item -->
                        <!-- start client item -->
                        <div class="swiper-slide">
                            <div class="fs-50 text-dark-gray alt-font fw-700 ls-minus-1px"><span class="align-middle border border-2 w-15px h-15px border-radius-100 border-color-medium-gray d-inline-block ms-50px me-50px"></span> Get offer up to 50% on modern furniture</div>
                        </div>
                        <!-- end client item -->
                        <!-- start client item -->
                        <div class="swiper-slide">
                            <div class="fs-50 text-dark-gray alt-font fw-700 ls-minus-1px"><span class="align-middle border border-2 w-15px h-15px border-radius-100 border-color-medium-gray d-inline-block ms-50px me-50px"></span> Free shipping for orders over $130</div>
                        </div>
                        <!-- end client item -->
                        <!-- start client item -->
                        <div class="swiper-slide">
        ...
        <div class="p-0 container-fluid">
            <div class="row g-0">
                <div class="col-md-8 cover-background" style="background-image:url('https://placehold.co/1280x640')" data-anime='{ "translateX": [-50, 0], "opacity": [0,1], "duration": 600, "delay":150, "staggervalue": 150, "easing": "easeOutQuad" }'>
                    <div class="w-40 pt-13 pb-13 pe-5 xl-w-45 lg-w-55 md-w-65 sm-w-50 xs-w-270px float-end">
                ...
                <div class="col-md-4" data-anime='{ "translateX": [50, 0], "opacity": [0,1], "duration": 600, "delay":150, "staggervalue": 150, "easing": "easeOutQuad" }'>
                    <div class="swiper position-relative h-100" data-slider-options='{ "slidesPerView": 1, "loop": true, "allowTouchMove": true, "autoplay": { "delay": 3000, "disableOnInteraction": false }, "navigation": { "nextEl": ".slider-one-slide-next-1", "prevEl": ".slider-one-slide-prev-1" }, "effect": "fade" }'>
                        <div class="swiper-wrapper">
                            ...
                            <div class="text-center swiper-slide cover-background h-100" style="background-image: url(images/demo-decor-store-product-slider-bg-img.jpg)">
                                <a href="demo-decor-store-single-product.html">
                                    <img src="https://placehold.co/640x640" alt=""/>
                                </a>
                                <div class="left-0 text-center position-absolute bottom-70px xs-bottom-25px w-100 ls-minus-05px">
                                    <a href="demo-decor-store-single-product.html" class="text-dark-gray alt-font d-inline-block fs-20 fw-600">Wooden cabinet</a>
                                    <div class="d-block">
                                        <div class="align-middle d-inline-block fs-18 fw-600 text-dark-gray"><del class="me-10px">$50.00</del>$23.00</div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="text-center swiper-slide cover-background h-100" style="background-image: url(images/demo-decor-store-product-slider-bg-img.jpg)">
                                ...
                                <div class="left-0 text-center position-absolute bottom-70px xs-bottom-25px w-100 ls-minus-05px">
                                    ...
                                    <div class="d-block">
                                        <div class="align-middle d-inline-block fs-18 fw-600 text-dark-gray"><del class="me-10px">$40.00</del>$18.00</div>
                                    </div>
                                </div>
                            </div>
                            <!-- end text slider item -->
                            ...
                            <div class="text-center swiper-slide cover-background h-100" style="background-image: url(images/demo-decor-store-product-slider-bg-img.jpg)">
                                ...
                                <div class="left-0 text-center position-absolute bottom-70px xs-bottom-25px w-100 ls-minus-05px">
                                    ...
                                    <div class="d-block">
                                        <div class="align-middle d-inline-block fs-18 fw-600 text-dark-gray"><del class="me-10px">$56.00</del>$24.00</div>
                                    </div>
                                </div>
                            </div>
                            <!-- end text slider item -->
    ...
    <section class="pb-3 bg-gradient-very-light-gray lg-pb-40px md-pb-20px">
        <div class="container">
            <div class="row justify-content-center mb-25px">
                <div class="text-center col-lg-5" data-anime='{ "el": "childs", "translateY": [50, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 150, "easing": "easeOutQuad" }'>
            ...
            <div class="row">
                <div class="col-12">
                    <ul class="grid blog-classic blog-wrapper grid-loading grid-4col xl-grid-4col lg-grid-3col md-grid-2col sm-grid-2col xs-grid-1col gutter-extra-large" data-anime='{ "el": "childs", "translateY": [50, 0], "opacity": [0,1], "duration": 600, "delay":100, "staggervalue": 150, "easing": "easeOutQuad" }'>
                        <li class="grid-sizer"></li>
                        <!-- start blog item -->
                        <li class="grid-item">
                            <div class="bg-transparent border-0 card h-100">
                                <div class="overflow-hidden blog-image position-relative border-radius-4px">
                                    <a href="demo-decor-store-blog-single-classic.html"><img src="https://placehold.co/600x445" alt="" /></a>
                                </div>
                                <div class="px-0 card-body pt-30px pb-30px xs-pb-15px">
    ...
    <!-- end section -->
    <!-- start section -->
    <section class="py-0 overflow-hidden border-top border-color-extra-medium-gray">
        <div class="container-fluid">
            <div class="row row-cols-1 row-cols-lg-4 row-cols-sm-2 justify-content-center" data-anime='{ "el": "childs", "translateX": [50, 0], "opacity": [0,1], "duration": 600, "delay":100, "staggervalue": 150, "easing": "easeOutQuad" }'>
                ...
                <div class="text-center col d-flex justify-content-center icon-with-text-style-08 border-end md-border-bottom xs-border-end-0 border-color-extra-medium-gray pt-45px pb-45px">
                ...
                <!-- start features box item -->
                <div class="text-center col d-flex justify-content-center icon-with-text-style-08 border-end md-border-bottom md-border-end-0 border-color-extra-medium-gray pt-45px pb-45px">
                    <div class="align-middle feature-box feature-box-left-icon-middle d-inline-flex">
                        <div class="feature-box-icon me-15px">
                            <img src="https://placehold.co/60x50" alt=""/>
                        </div>
                ...
                <!-- end features box item -->
                <!-- start features box item -->
                <div class="text-center col d-flex justify-content-center icon-with-text-style-08 border-end xs-border-bottom xs-border-end-0 border-color-extra-medium-gray pt-45px pb-45px">
                    <div class="align-middle feature-box feature-box-left-icon-middle d-inline-flex">
                        <div class="feature-box-icon me-15px">
                            <img src="https://placehold.co/60x50" alt=""/>
                        </div>
                ...
                <!-- end features box item -->
                <!-- start features box item -->
                <div class="text-center col d-flex justify-content-center icon-with-text-style-08 pt-45px pb-45px">
                    <div class="align-middle feature-box feature-box-left-icon-middle d-inline-flex">
                        <div class="feature-box-icon me-15px">
                            <img src="https://placehold.co/60x50" alt=""/>
                        </div>
